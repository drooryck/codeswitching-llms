...
Adapted from apr14/pos_analysis.py to analyze sweep_apr16 (fixed-budget design).
"""
...
def main():
    print("Starting POS-language analysis (sweep_apr16)...", flush=True)
    ...
    fig.suptitle("Per-POS Language Alignment vs Training Proportion (apr16, fixed budget)",
    ...
    fig2.suptitle("Per-POS Language of NL Test Predictions, by Structure Type (apr16)",
                  fontsize=14, fontweight="bold")
    fig2.tight_layout()
