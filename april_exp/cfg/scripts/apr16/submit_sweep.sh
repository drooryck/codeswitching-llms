...
#SBATCH --array=0-8
#SBATCH --output=/n/netscratch/dam_lab/Lab/drooryck/codeswitching-llms/april_exp/cfg/results/sweep_apr16/logs/slurm_%A_%a.out
#SBATCH --error=/n/netscratch/dam_lab/Lab/drooryck/codeswitching-llms/april_exp/cfg/results/sweep_apr16/logs/slurm_%A_%a.err

# ── Sweep grid ─────────────────────────────────────────────────────
# Fixed-budget design: total examples = P regardless of trans_frac.
...
# ── Paths ──────────────────────────────────────────────────────────
OUTPUT_ROOT=/n/netscratch/dam_lab/Lab/drooryck/codeswitching-llms/april_exp/cfg/results/sweep_apr16
