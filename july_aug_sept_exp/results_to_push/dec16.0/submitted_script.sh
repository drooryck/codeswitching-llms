#!/bin/bash
# Direct run script for training on GPU node (no SLURM directives)
...
OUTPUT_ROOT=/n/home06/drooryck/codeswitching-llms/july_aug_sept_exp/results/dec16.0
CONFIG_JSON=/n/home06/drooryck/codeswitching-llms/july_aug_sept_exp/configs/default_model.json
DATA_DIR=/n/home06/drooryck/codeswitching-llms/july_aug_sept_exp/data # or data/data_no_plurality_mixing
...
exp.run_single_nov21(prop=${PROP}, run_id=${RUN_ID}, eval_prop=${EVAL_PROP})
PYCODE
